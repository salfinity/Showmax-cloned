        ...
        <div className="flex justify-center pb-2">
          <div className="bg-slate-300 px-16 py-16 self-center mt-2 lg:w-2/5 lg:max-w-md rounded-md w-full">
            ...
            <button
              ...
              className="bg-pink-600 py-3 text-white font-bold rounded-full w-full mt-10 hover:bg-pink-500 transition"
            >
            ...
            <p className="text-neutral-950 text-center justify-center mt-4">
              {variant === "login"
                ? "First time using Showmax?"
                : "Already have an account?"}
              <span
                onClick={toggleVariant}
                className="text-neutral-800 ml-1 hover:underline cursor-pointer"
              >
          ...
          <div className="text-gray-300 flex-row self-center fixed bottom-0 left-0 z-20 w-full p-4 bg-none md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600 flex flex-wrap md:flex-wrap md:fixed md:mt-4">
            <span className="text-sm text-gray-300 sm:text-center dark:text-gray-400 hover:text-pink-500 cursor-pointer">
              <Link
                target="_blank"
                href="https://faq.showmax.com/eng/legal/ke/service-terms-ke"
              >
                Terms & Conditions
              </Link>
            </span>
