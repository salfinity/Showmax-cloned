...
const Navbar = () => {
  ...
  return (
    <nav className="w-full fixed top-0 z-40">
      <div
        className={`px-2 md:px-16 py-0 flex flex-row flex-nowrap items-center transition duration-500 ${
      ...
      >
        ...
        <div className="px-4 py-5 flex-row justify-center lg:flex ml-auto mr-auto">
          <img
            src="/images/logo.png"
            className="h-8 lg:h-10 flex flex-row justify-center relative cursor-pointer duration-500"
            alt="Logo"
          />
        </div>
        <div className="flex flex-row ml-auto gap-4 items-center relative">
          ...
          <div
            ...
            className="flex flex-row items-center gap-4 px-2 py-1 cursor-pointer hover:text-gray-950 hover:bg-gray-200 hover:rounded-full relative"
          >
            <div className="w-6 h-6 lg:w-10 lg:h-10 rounded-full overflow-hidden">
              <img src="/images/default-blue.png" alt="" />
            </div>
            <BsChevronDown
              className={`text-white text-bold transition hover:text-gray-950 ${
