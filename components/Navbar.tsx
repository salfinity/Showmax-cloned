...
const Navbar = () => {
 ...
 return (
    <nav className="w-full fixed top-0 z-40">
      <div className={`px-4 md:px-16 py-4 flex flex-row flex-nowrap items-center transition duration-500 ${showBackground ? 'bg-zinc-900 bg-opacity-90' : ''}`}>
       ...
       <img src="/images/logo.png" className="h-8 lg:h-10 flex flex-row justify-center relative" alt="Logo" />
       </div>
